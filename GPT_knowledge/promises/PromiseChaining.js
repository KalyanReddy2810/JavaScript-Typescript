...
Promise.resolve(10)
    .then(x => new Promise(resolve => setTimeout(() => resolve(x * 2), 1000))) // returns Promise(20) after 1s  , resolve holds the value 20 after 1s & resolve value will be passed to next then i.e x in next then will be 20
